...
pub fn draw_chart(
    ...
    let original_prepared_set_info = create_set_with_info(original.0, a as f64, b as f64, IMAGE_WIDTH/2, CLEAR);
    ...
    let mut chart = ChartBuilder::on(&root)
        ...
        .build_cartesian_2d(graph_left_border..graph_right_border, graph_low_border..graph_top_border)?;

    chart.configure_mesh().draw()?;

    chart
        .draw_series(LineSeries::new(
            original_prepared_set.iter()
